        ...
        <div className="max-width">
          ...
          <div className="relative flex flex-col md:flex-row items-center md:items-start gap-10 md:gap-5">
            ...
            <article className="relative z-10 bg-white rounded-lg shadow-lg p-5 text-center md:text-left flex flex-col items-center md:items-start lg:mb-5">
              ...
              <p className="text-[#A7A4AA] poppins text- mt-3">
            ...
            <article className="relative z-10 bg-white rounded-lg shadow-lg p-5 text-center md:text-left flex flex-col items-center md:items-start lg:mt-10">
              <div className="p-5 -mt-12 w-16 h-16 bg-[#3B2F55] rounded-full flex items-center justify-center">
